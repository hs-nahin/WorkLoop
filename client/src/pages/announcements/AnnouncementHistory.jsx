  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Announcement History</h1>
          <p className="text-muted-foreground">Review previous organizational communications</p>
        </div>
      </div>
        ...
        {announcements.length === 0 ? (
          ...
          announcements.map((ann) => (
            <BlurFade key={ann.id} delay={0.1}>
              <MagicCard className="p-4 flex items-start gap-4">
